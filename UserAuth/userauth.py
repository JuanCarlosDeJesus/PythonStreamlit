...
if authentication_status:
    ...
    # ---- MAINPAGE ----
    st.title(":bar_chart: Salese Dashboard")
    st.markdown("##")
    ...
    # st.dataframe(df_selection) - pandas
    # SALES BY PRODUCT LINE[BAR CHART]
    sales_by_product_line = df_selection.groupby(by=["Product line"])[["Total"]].sum().sort_values(by="Total")  # adjusted [["Total"]].sum()
